...
/* harmony import */ var _components_gallery__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/gallery */ "./src/gallery/components/gallery.js");
/* harmony import */ var _scss_header_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../scss/header.scss */ "./scss/header.scss");
...
function Edit(_ref) {
  ...
  const [selectedCollection, setSelectedCollection] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    }).then(data => setCollections([...collections, ...data])).catch(err => console.log(err));
  }, []);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
  ...
  const renderForm = () => {
    ...
    }, renderOptionHTML()), selectedCollection && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, preview ? "Hide Preview" : "Show Preview")), preview && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_gallery__WEBPACK_IMPORTED_MODULE_5__["default"], {
...
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.scss */ "./src/gallery/index.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/gallery/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/gallery/save.js");
...
function save(_ref) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()({
      path: `/wp/v2/atypic_gallery/${selectedCollection}`
    }).then(data => setCollection({
      data
    }));
  }, []);
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, title));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["atypic-header/style-index"], function() { return __webpack_require__("./src/gallery/index.js"); })
