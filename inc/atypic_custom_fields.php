...
function atypic_metaboxes()
{
    ...
    $cmb = \new_cmb2_box([
        ...
        "object_types" => ["atypic_gallery"], // Post type
        "context" => "normal",
        "priority" => "high",
        ...
        "cmb2_api_update_field_value_permissions_check" =>
            "atypic_gallery_permission",
        "cmb2_api_delete_field_value_permissions_check" =>
            "atypic_gallery_permission",
    ]);
